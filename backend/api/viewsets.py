...
def _artifact_kv(artifact: Artifact) -> List[Tuple[str, str]]:
    ...
    base: Dict[str, Any] = {
        ...
        "main_code_plan_square": s.get("main_code_plan_square"),
        "main_code_description": s.get("main_code_description"),
        "main_code_layer": s.get("main_code_layer"),
        "main_code_level": s.get("main_code_level"),
        "main_code_grave_no": s.get("main_code_grave_no"),
        "main_code_gis": s.get("main_code_gis"),
...
def _artifact_sections(artifact: Artifact) -> Dict[str, Any]:
    ...
    return {
        "general": {
            ...
            "PlanKare": s.get("main_code_plan_square") or "",
            "Açıklama": s.get("main_code_description") or "",
            "Tabaka": s.get("main_code_layer") or "",
            "Seviye": s.get("main_code_level") or "",
            "Mezar No": s.get("main_code_grave_no") or "",
            "GIS": s.get("main_code_gis") or "",
